package me.spiegel.paz.turndetect.feature;
...
//
//		double[] orginaldata = WavefilereaderMain.getPCMdataFromWave( "fingerprint//" + "p580ms15k.wav");//���ڴ�raw��ȡ�����ļ�
//		for (int i = 0; i <orginaldata.length; i++) {
//			x[i] = new Complex(orginaldata[i], 0);
